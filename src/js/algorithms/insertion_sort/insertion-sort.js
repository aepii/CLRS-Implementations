...
*/
export function insertionSort(array, ascending=true) {
  // Build sorted array one element at a time. 
  // Assume the first element is already "sorted".
  for (let j = 1; j < array.length; j++) {
    let key = array[j] // Key element to be inserted into the sorted array.
    let i = j - 1 // Index to the left of the key element.
